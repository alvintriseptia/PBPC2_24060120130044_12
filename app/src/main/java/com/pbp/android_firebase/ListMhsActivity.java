...
public class ListMhsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fetchKey = new ArrayList<>();

        //inisialisasi objek untuk ke firebase
        databaseReference = FirebaseDatabase.getInstance("https://praktikum-firebase-a0e14-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("mhs");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                myAdapter.setOnItemClickListener(new MyAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(int position) {
                        String key = fetchKey.get(position);
                        startActivity(new Intent(ListMhsActivity.this,EditMhsActivity.class).putExtra("key",key));
                    }
                });
